...
int main(int argc, char* argv[]) {
  ...
  GeneralDouble* g10 = new GeneralDouble(2000L);
  ...
  GeneralDouble* g13 = new GeneralDouble(50L);
  ...
  GeneralDouble* g17 = new GeneralDouble(20L);
  ...
  printf("\nDemostrating parse() (Lab4):\n");
  GeneralNumber * gg1 = GeneralNumber::parse("4");
  if(gg1 == 0){
    printf("\nNull\n");
  } else {
  gs = gg1->toString();
  ...
  GeneralNumber * gg2 = GeneralNumber::parse(" [ 7 / 3 ]");
  ...
  GeneralNumber * gg3 = GeneralNumber::parse("a");
